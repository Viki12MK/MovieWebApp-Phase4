...
def get_users():
      """
      Get all users and render the users page.

      Returns:
          str: HTML content for the users page.
      """
...
def display_user_movies(user_id):
      ...
      Returns:
          str: HTML content for the user's movies page.
      """
...
def get_user_movies(user_id):
      """
      Get movies for a specific user and render the user's movies page.
...
def add_user():
      """
      Add a new user and render the add user page.

      Returns:
          str: HTML content for the add user page.
      """
...
def add_movie(user_id):
      """
      Add a movie for a specific user and render the add movie page.

      Args:
          user_id (int): The ID of the user.

      Returns:
          str: HTML content for the add movie page.
      """
      if request.method == 'POST':
            ...
            if any(movie['name'].lower() == movie_name.lower() for movie in user_movies):
                  existing_movie = next((movie for movie in user_movies if movie['name'].lower() == movie_name.lower()), None)
                  return render_template('add_movie.html', user_id=user_id, user_name=user_name, movie_exist=existing_movie, new_movie=None)
...
def update_movie(user_id, movie_id):
      """
      Update a movie for a specific user and render the update movie page.
      ...
      Returns:
          str: HTML content for the update movie page.
      """
...
def update_movie_method_override(user_id, movie_id):
      """
      Update a movie for a specific user using method override.
      ...
      Returns:
          str: HTML content for the update movie page.
          int: HTTP status code (405 Method Not Allowed for non-PUT requests).
      """
...
def delete_movie(user_id, movie_id):
      ...
      Returns:
          str: HTML content for the delete movie page.
          int: HTTP status code (404 if user or movie not found, 302 if successful delete).
      """
      user = data_manager.get_user_by_id(user_id)
      if user:
